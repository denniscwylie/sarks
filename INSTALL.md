...
- SeqAn C++ library (https://www.seqan.de/) **version 1.3.x** or **1.4.x**
  ...
  -  <a name="seqan-download"></a>
     ...
     a package manager, you can download [packages.seqan.de/seqan-library/seqan-library-1.4.2.tar.bz2](http://packages.seqan.de/seqan-library/seqan-library-1.4.2.tar.bz2)
