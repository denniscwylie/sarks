...
# NOTE: using fewer permutations speeds up motif selection but
#       makes results more variable from run to run; may also result
#       in larger false positive rates when tested with sarkstest.py below.
