...
#     can supply multiple values using commas (no spaces)>
# -p     (takes no argument;
#         a logical flag indicating to remove redundant kmer output,
...
# and will be used by the sarkstest.py script below.
...
# -o <output directory for testing; will be created/overwritten>
## -----------------------------------------------------------------
